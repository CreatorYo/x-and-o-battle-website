...
const features = [
  {
    icon: <Paintbrush className="h-8 w-8 text-rose-400" />,
    title: "Theme Customisation",
    description: "Customise your game with unique presets and accent colors.",
    bgColor: "bg-rose-500/20",
    spotlightColor: "rgba(244, 63, 94, 0.1)", // rose-500 with low opacity
  ...
  },
  {
    ...
    spotlightColor: "rgba(59, 130, 246, 0.1)", // blue-500 with low opacity
  ...
  },
  {
    ...
    spotlightColor: "rgba(234, 179, 8, 0.1)", // yellow-500 with low opacity
  ...
  },
  {
    ...
    spotlightColor: "rgba(34, 197, 94, 0.1)", // green-500 with low opacity
    selectionClass: "feature-green"
  },
  {
    icon: <Save className="h-8 w-8 text-purple-400" />,
    title: "Data Saved",
    description: "Your achievements and data are saved automatically.",
    bgColor: "bg-purple-500/20",
    spotlightColor: "rgba(168, 85, 247, 0.1)", // purple-500 with low opacity
    selectionClass: "feature-purple"
  },
  {
    icon: <Shield className="h-8 w-8 text-orange-400" />,
    title: "Privacy Respected",
    description: <>We deeply respect your privacy with no ads and no data tracking. <Link href="https://policies.creatoryogames.com/x-and-o-battle-policies-game/privacy-policy" className="text-orange-400 hover:underline" target="_blank" rel="noopener noreferrer">Learn more</Link></>,
    bgColor: "bg-orange-500/20",
    spotlightColor: "rgba(249, 115, 22, 0.1)", // orange-500 with low opacity
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            ...
            >
              <div className={`absolute inset-0 opacity-10 ${feature.bgColor}`} />
              {isHovering === index && (
                <div
